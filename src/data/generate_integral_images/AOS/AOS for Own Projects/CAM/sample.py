...
if __name__ == "__main__":
    ...
    frame_queue, camera_process_event, get_frames_event = (
    ...
    camera_process = multiprocessing.Process(
        name="camera_process",
        target=camera_class.AcquireFrames,
        args=(frame_queue, camera_process_event, get_frames_event),
    )
    ...
    for image in frames_info["Frames"]:
        ...
        cv2.imshow(
            "undistorted image {} (time: {:.1f})".format(count, times[count - 1]), im
        )
