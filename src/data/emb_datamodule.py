...
class EmbeddingDataSet(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # load embeddings
        embeddings = torch.stack([load_file(file)["last_hidden_states"] for file in sample["embeddings"][:4]],
                                 dim=1).squeeze(0)
...
class EmbeddingDataModule(ImageDataModule):
    ...
    def setup(self, stage: Optional[str] = None) -> None:
        ...
        self.data_test: Optional[Dataset] = EmbeddingDataSet(data_paths[train_size + val_size:])
